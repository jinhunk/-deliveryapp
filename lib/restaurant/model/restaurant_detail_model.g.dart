...
RestaurantDetailModel _$RestaurantDetailModelFromJson(
    ...
    RestaurantDetailModel(
      ...
      products: (json['products'] as List<dynamic>)
          .map(
              (e) => RestaruantProductModel.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
RestaruantProductModel _$RestaruantProductModelFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$RestaruantProductModelToJson(
        RestaruantProductModel instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
